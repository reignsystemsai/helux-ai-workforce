...
const { firstCallScript, reconnectScript } = require("./daisy-script");
...
Daisy listens, reasons about the current conversation objective, and speaks. HELUX performs data, CRM, messaging, calculations, transfers, compliance, and reporting.
...
- If an action fails, do not claim completion. Briefly say you could not complete it just now, then offer a specialist handoff when appropriate.
`.trim();
}
